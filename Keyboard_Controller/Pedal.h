/* 
foot pedal scanned by diode matrix
dynamic is not supported, only on/off 
*/

/**
 * Called if a state change is detected by the pedal scanner.
 * @param pedal 0 = most left pedal
 * @param on true if the pedal has been pressed, else it has been released
 */
